module gameLogic {
    ...
    //Helper for getSets
    function getWeb(color:any, row:any, col:any, board:any) {
        var points:any = [];
        var leader = createNewBoard();

        function tryPoints(row:any, col:any) {
            points.push([row,col]);
    ...
    //Helper for getSets
    function mergeBoards(leader:any, links:any) {
    ...
    function getSets(board:any) {
        var leaderX = createNewBoard();
        var leaderO = createNewBoard();
        var setsX:any = []; // black sets
        var setsO:any = []; // white sets
        var row:any, col:any;
        var connectInfo:any;
        for (row = 0; row < dim; row++) {
            for (col = 0; col < dim; col++) {
    ...
    function cleanBoard(board:any, arr:any) {
        var newboard = copyObject(board);
        var i:any, row:any, col:any;
    ...
    function evaluateBoard(board:any, captured:any, turn:any) {
    ...
    function getWinner(captured:any) {
        var winner = 'O';
    ...
    export function createComputerMove(boardbeforeMove:any, board:any, captured:any, passes:any, turnIndexBeforeMove:any) {
        var possibleMoves:any = [];
        var i:any, j:any, delta:any, testmove:any, newcaptured:any;
        for (i = 0; i < dim; i++) {
            for (j = 0; j < dim; j++) {
                delta = {row: i, col: j};
                try {
    ...
    function getboardNum (board:any, turnIndex:any) {
        var sum = 0;
        var i:any, j:any;
    ...
    export function createMove(boardbeforeMove:any, board:any, delta:any, captured:any, passes:any, turnIndexBeforeMove:any) {
        ...
        var setnumBefore:any, setnumAfter:any;
        ...
        var firstOperation:any; // Either endMatchScores or setTurn
        if (passesAfterMove === 2) {
